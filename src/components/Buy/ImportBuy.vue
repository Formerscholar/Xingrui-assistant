      ...
      <el-row :gutter="20">
        <el-col :span="24">
          ...
          >
            ...
            <el-table-column prop="hour" label="购买课时(节)"></el-table-column>
            <el-table-column prop="type" label="课时类型"></el-table-column>
...
import {BuyImport} from '@/network/buy'
...
export default {
  ...
  setup(props, context) {
    ...
    const state = reactive({
      dialogVisible:false,
      list:[],
      upload_url:"/ins/Course/uploadBuy",
      template_rul:"/ins/block/downTpl?type=buy",
    })
