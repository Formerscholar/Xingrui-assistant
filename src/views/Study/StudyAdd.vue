    ...
    <div class="main_box">
      <div class="left">
        <div class="box form_box">
          <h4 style="margin-bottom: 1rem">添加上课记录</h4>
          <el-form :model="study_data" :rules="rules" ref="form_ref" label-width="80px">
            <el-form-item label="课程" prop="course_id">
              <el-select v-model="study_data.course_id">
                <el-option
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="学生" prop="student_id">
                  <el-select v-model="study_data.student_id" multiple>
                    <el-option
              ...
              <el-col :span="8">
                <el-form-item label="上课时间" prop="study_time">
                  <el-date-picker type="datetime" placeholder="选择日期时间" v-model="study_data.study_time"></el-date-picker>
                </el-form-item>
              </el-col>
            </el-row>
...
import { addStudy } from '@/network/Study'
          ...
          state.search_condition.question.forEach((item) => {
            if(item.is_check)
              checked_quesitons.push({
                ...
                question_know_point:item.question_data.know_point
              })
          })
          params.questions = checked_quesitons

          let {code,data,msg} = await addStudy(params)
